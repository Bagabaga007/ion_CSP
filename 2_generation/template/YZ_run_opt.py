...
from deepmd_pt.utils.ase_calc import DPCalculator as MLP
...
def run_opt(index): 
    ...
    write_OUTCAR(element, ele, atoms_masses, atoms_vol, atoms_lat, atoms_pos, atoms_ene, atoms_force, atoms_stress * -10.0, pstress, index)
...
if __name__=='__main__':
    ...
    for index in indexes:
        pool.apply(func=run_opt,args=(index,))
    pool.close()
    pool.join()